...
class WSv2 extends EventEmitter {
  ...
  submitOffer (order) {
    ...
    debug(`creating offer ${JSON.stringify(order)}`)
    this._sendOrderPacket([0, 'fon', null, order])

    return this._getEventPromise(`forder-new`)
  }
  ...
  cancelOffer (order) {
    ...
    return this._getEventPromise(`forder-cancel`)
  }  
